...
Добавлено ООП - чтоб редактировать свойства запроса на сервер и при этом использовать раннее написаныые функции. \
 ...
 На 24/,08
  - После обновления строки (контента в ЛК) убрать 'input' вернуть строку.
 - добавить функцию удалить.
 - `/profile/profile_dalete` при удалении фккаунта, в логику добавить контент/строки из CRUD. После удалить таблицу с email.

На 25,08
 - Пользоватею добавить статус = "Админ" б "Пользователь"
...
Note Totall:
 - При авторизации аккаунта/usera , где-то в степях браузера (с лево и 50% по ывсоте можно заметить иаленький loader/загрузчик/анимацию)
