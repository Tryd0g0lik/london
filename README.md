...
На *.08
 - `/profile/profile_dalete` при удалении фккаунта, в логику добавить контент/строки из CRUD. После удалить таблицу с email. - проверить
 -  Получить список добрый дел профиля , перед добавлением в друзья
